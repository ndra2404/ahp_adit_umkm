...
class Rangking{
	...
	function insertHasil($a,$b){
		
		$query = "insert into ahp_hasil(alternatif,bobot) values('$a',$b)";
		$stmt = $this->conn->prepare($query);
	...
	function hapusRangking(){
	
		$query = "TRUNCATE TABLE ahp_hasil";
