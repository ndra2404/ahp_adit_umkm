...
<div class="row">
	...
	<strong style="font-size:18pt;"><span class="fa fa-table"></span>Normalisasi Matriks</strong>
		<table width="100%" class="table table-striped table-bordered">
			<thead>
				<tr>
					<th>Perbandingan</th>
		...
		<strong style="font-size:18pt;"><span class="fa fa-table"></span>Matriks Penjumlahan Tiap Baris</strong>
		<table width="100%" class="table table-striped table-bordered">
			<thead>
				<tr>
					<th>Penjumlahan</th>
		...
		<table width="100%" class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>CR (<?=$ci?>/<?=$ir?>)</th>
					<td><?php $cr = ($ci/$ir)*-1; echo number_format($cr, 4, '.', ',');?>(<?=$cr<=0.1?'Tidak Konsisten':'Konsisten'?>)</td>
				</tr>
			</tbody>
		</table>
	</div>
